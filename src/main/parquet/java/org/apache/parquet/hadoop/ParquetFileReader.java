...
public class ParquetFileReader implements Closeable {
  ...
  class WorkaroundChunk extends Chunk {
     ...
     */
    WorkaroundChunk(ChunkDescriptor descriptor, byte[] data, int offset, SeekableInputStream f) {
  ...
  class ConsecutiveChunkList {
    ...
    protected final List<ChunkDescriptor> chunks = new ArrayList<ChunkDescriptor>();
